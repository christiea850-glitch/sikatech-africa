...
const styles: Record<string, React.CSSProperties> = {
  header: {
    ...
    boxShadow: "0 10px 24px rgba(69, 49, 17, 0.08)",
  ...
  search: {
    ...
    outline: "none",
    background: "var(--sk-card-strong)",
    color: "var(--sk-text)",
    fontWeight: 500,
    boxShadow: "inset 0 1px 1px rgba(69,49,17,0.05)",
  },
  ...
  rolePill: {
    padding: "8px 12px",
    borderRadius: 999,
    background: "rgba(214, 165, 31, 0.22)",
    color: "var(--sk-navy)",
    border: "1px solid rgba(214, 165, 31, 0.34)",
    fontWeight: 800,
    textTransform: "capitalize",
    fontSize: 12,
    whiteSpace: "nowrap",
  ...
  logout: {
    border: "1px solid rgba(214, 165, 31, 0.30)",
    cursor: "pointer",
    padding: "10px 14px",
    borderRadius: 12,
